...
return [
    ...
    | Basic authentication on every request. They have no config defaults, so a
    | missing SMS_GATEWAY_PLIVO_AUTH_ID or SMS_GATEWAY_PLIVO_AUTH_TOKEN
    ...
    */
    ...
    | Base URL
    |--------------------------------------------------------------------------
    | The endpoint the Plivo driver sends requests to. This value is the
    | single source of truth for the host: edit it here, or set
    | SMS_GATEWAY_PLIVO_BASE_URL, when a proxy or a sandbox environment
    | requires a different one. The auth id is not part of it; the driver
    ...
    */
    ...
    'timeout' => [
        'server' => (int) env('SMS_GATEWAY_PLIVO_SERVER_TIMEOUT', env('SMS_GATEWAY_SERVER_TIMEOUT', 5)),
        'client' => (int) env('SMS_GATEWAY_PLIVO_CLIENT_TIMEOUT', env('SMS_GATEWAY_CLIENT_TIMEOUT', 6)),
    ],
    ...
    */
    ...
    'retry' => [
        'times'              => (int) env('SMS_GATEWAY_PLIVO_RETRY_TIMES', env('SMS_GATEWAY_RETRY_TIMES', 2)),
        'sleep_milliseconds' => (int) env('SMS_GATEWAY_PLIVO_RETRY_SLEEP_MILLISECONDS', env('SMS_GATEWAY_RETRY_SLEEP_MILLISECONDS', 100)),
    ],
