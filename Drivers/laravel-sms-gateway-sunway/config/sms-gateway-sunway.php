...
return [
    ...
    | There is no default: a missing or empty value fails at driver resolution.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The endpoint the Sunway driver sends requests to. Edit it here, or set the
    ...
    */
    ...
    'timeout' => [
        'server' => (int) env('SMS_GATEWAY_SUNWAY_SERVER_TIMEOUT', 5),
        'client' => (int) env('SMS_GATEWAY_SUNWAY_CLIENT_TIMEOUT', 6),
    ],
    ...
    */
    ...
    'retry' => [
        'times'              => (int) env('SMS_GATEWAY_SUNWAY_RETRY_TIMES', 2),
        'sleep_milliseconds' => (int) env('SMS_GATEWAY_SUNWAY_RETRY_SLEEP_MILLISECONDS', 100),
    ],
