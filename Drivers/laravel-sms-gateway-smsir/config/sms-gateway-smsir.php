...
return [
    ...
    | the "X-API-KEY" header on every request. There is no default: a missing or
    | empty value fails at driver resolution.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The endpoint the SMS.ir driver sends requests to. Edit it here, or set the
    ...
    */
    ...
    'timeout' => [
        'server' => (int) env('SMS_GATEWAY_SMSIR_SERVER_TIMEOUT', 5),
        'client' => (int) env('SMS_GATEWAY_SMSIR_CLIENT_TIMEOUT', 6),
    ],
    ...
    */
    ...
    'retry' => [
        'times'              => (int) env('SMS_GATEWAY_SMSIR_RETRY_TIMES', 2),
        'sleep_milliseconds' => (int) env('SMS_GATEWAY_SMSIR_RETRY_SLEEP_MILLISECONDS', 100),
    ],
